...
function buttonAction1(){
  document.getElementById("FillSongs").innerHTML = " "; // This is to reset the div
  ...
  sendPostRequest("/getList", cityJson)
    .then(function (val) {
        console.log(
        ...
        val = JSON.parse(val);
        var elem = document.getElementById("FillSongs");
  ...
  sendPostRequest("/getList", cityJson)
    .then(function (val) {
        ...
        for (let i = 0; i < val.length; ++i){
          ...
          elem.appendChild(stuffToAdd); // appends text to the div
          elem.appendChild(img);   // appends an image of the url to the div
          elem.appendChild(br);   // appends a <br> to the div
          img.style.marginLeft = "100px";
